...
```
---
- **Visualization in Wikibase:** The next step was to import the generated RDF graph into **Wikibase Docker** in order to visualize the knowledge graph. Although the RDF file was imported successfully, the contained entities and relationships were not available within Wikibase as expected.
